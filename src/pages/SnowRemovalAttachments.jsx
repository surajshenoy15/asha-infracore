  ...
  useEffect(() => {
    const fetchAttachments = async () => {
      try {
        ...
        const filtered = res.data.filter((a) => a.category.toLowerCase() === 'snow-removal');
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-[400px] overflow-hidden">
        <img
          src="/categories/snow-removal.png"
          alt="Snow Removal Attachments Banner"
      ...
      <div className="bg-white py-10 border-b">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-red-600 mb-4">Snow Removal Attachments</h2>
          <nav className="text-lg text-gray-600">
            ...
            <span className="mx-3 text-gray-400">/</span>
            <span className="text-red-600 font-semibold">Snow Removal</span>
          </nav>
        </div>
      </div>
      ...
      <div className="py-16 px-4 bg-[#f5f5f5]">
        <div className="max-w-7xl mx-auto">
          {loading ? (
            ...
            <p className="text-center text-gray-500">No attachments found for Snow Removal.</p>
          ) : (
            ...
            {[
              {
                ...
                image: '/tires.png',
                desc: 'Strong grip and durability for smooth, reliable performance on any terrain.',
                link: '/parts/tires',
              },
              {
                title: 'Bobcat Batteries',
                image: '/battery.png',
                desc: 'Dependable starting power and long-lasting performance in all conditions.',
                link: '/parts/batteries',
              },
              {
                title: 'Bobcat Fluids and Lubricants',
                image: '/fluid.png',
                desc: 'Specially formulated to protect your equipment and maximize performance.',
                link: '/parts/fluids',
              },
            ].map((item) => (
              <Link
...
export default SnowRemovalAttachments;

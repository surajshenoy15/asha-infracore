...
const LiftingAndHandlingAttachments = () => {
  ...
  return (
    <div className="bg-[#f5f5f5] text-gray-800 min-h-screen">
      ...
      <div className="relative h-[400px] overflow-hidden">
        <img
          src="/categories/lifting-handling.png"
          alt="Lifting & Handling Attachments Banner"
      ...
      <div className="bg-white py-10">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <nav className="text-lg text-gray-600">
            ...
            <span className="mx-3 text-gray-400">/</span>
            <span className="text-red-600 font-semibold">Lifting & Handling</span>
          </nav>
        </div>
      </div>
      ...
      <div className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          {currentAttachments.length === 0 ? (
            <p className="text-center text-gray-500">No attachments found for Lifting & Handling.</p>
          ) : (
...
export default LiftingAndHandlingAttachments;

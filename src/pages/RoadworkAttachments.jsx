  ...
  useEffect(() => {
    const fetchAttachments = async () => {
      try {
        ...
        const filtered = res.data.filter((a) => a.category.toLowerCase() === 'roadwork');
  ...
  return (
    <div className="bg-[#f5f5f5] text-gray-800 min-h-screen">
      ...
      <div className="relative h-[400px] overflow-hidden">
        <img
          src="/categories/roadwork.png"
          alt="Roadwork Attachments Banner"
      ...
      <div className="bg-white py-10">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-red-600 mb-4">Roadwork Attachments</h2>
          <nav className="text-lg text-gray-600">
            ...
            <span className="mx-3 text-gray-400">/</span>
            <span className="text-red-600 font-semibold">Roadwork</span>
          </nav>
        </div>
      </div>
      ...
      <div className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          {currentAttachments.length === 0 ? (
            <p className="text-center text-gray-500">No attachments found for Roadwork.</p>
          ) : (
      ...
      <div className="bg-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-red-600 mb-12 text-center">You Might Also Like</h2>
...
export default RoadworkAttachments;

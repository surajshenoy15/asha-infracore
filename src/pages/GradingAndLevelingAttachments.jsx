    ...
    const fetchAttachments = async () => {
      try {
        ...
        const filtered = res.data.filter(a =>
          a.category?.toLowerCase().replace(/[\s&]+/g, '-') === 'grading-and-leveling'
        );
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="relative h-[400px] overflow-hidden">
        <img
          src="/categories/grading.png"
          alt="Grading Attachments Banner"
      ...
      <div className="bg-white py-10 border-b">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-red-600 mb-4">Grading Attachments</h2>
          <nav className="text-lg text-gray-600">
            ...
            <span className="mx-3 text-gray-400">/</span>
            <span className="text-red-600 font-semibold">Grading</span>
          </nav>
        </div>
      </div>
      ...
      <div className="py-16 px-4 bg-[#f5f5f5]">
        <div className="max-w-7xl mx-auto">
          {currentAttachments.length === 0 ? (
            <p className="text-center text-gray-500">No attachments found for Grading.</p>
          ) : (
...
export default GradingAttachments;
